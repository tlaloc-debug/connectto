...
app.get("/userappointmentsfixcar", (req, res) => {
    pool.query("select appuser,name,applocation,appdate,apptime,stars,reviews,datereview from appusers,users where appuser=myuser", function(err, result) {
        // If an error occurred...
        if (err) {
            console.log("Error in query: ")
            console.log(err);
...
app.get("/allreviewsfixcar", (req, res) => {
    pool.query("select loginuser,name,image,language,stars,myreview,myreviewdate from reviews,users where loginuser=myuser union select appuser,name,image,language,stars,reviews,datereview from appusers,users where reviews is not null and appuser=myuser;", function(err, result) {
        // If an error occurred...
        if (err) {
            console.log("Error in query: ")
            console.log(err);
